...
Zeta = LINETCR.LINE() #(just bot)
#Zeta.login(qr=True)
Zeta.login(token='token')
Zeta.loginResult()
print "Zeta-Login Success\n"

km = LINETCR.LINE() #(just bot)
#km.login(qr=True)
...
╠═════════════════════════
║            💠 by Zeta 💠
║    〽️ line.me/ti/p/~archaniczenit 〽️
╚═════════════════════════
"""
...
╚═════════════════════════
"""
vip="line.me/ti/p/~archaniczenit"
...
Fmid = Zeta.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"line.me/ti/p/~archaniczenit"]
Creator=["line.me/ti/p/~archaniczenit"]
admin=["line.me/ti/p/~archaniczenit"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : Zeta\nContact Me : 👉 line.me/ti/p/~archaniczenit",
    "comment2":"Auto Like ©By : Zeta\nContact Me : 👉 line.me/ti/p/~archaniczenit",
    "comment3":"Auto Like ©By : Zeta\nContact Me : 👉 line.me/ti/p/~archaniczenit",
    "comment4":"Auto Like ©By : Zeta\nContact Me : 👉 line.me/ti/p/~archaniczenit",
    "comment5":"Auto Like ©By : Zeta\nContact Me : 👉 line.me/ti/p/~archaniczenit",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
        ...
        if op.type == 19:
          ...
          try:
            if op.param3 in Fmid: #Akun Utama Ke Kick
              ...
              Zeta.acceptGroupInvitationByTicket(op.param1,Ti)
              time.sleep(0.01)
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                #random.choice(KAC).sendMessage(msg)               
		random.choice(KAC).sendText(msg.to,"Itu Admin (^_^)")	
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Zeta")
...
#		else:                    
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                msg.contentType = 13
                admin1 = "line.me/ti/p/~archaniczenit"
                msg.contentMetadata = {'mid': vip}
                random.choice(KAC).sendMessage(msg)
...
#		else:                    
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["zeta1 gift","zeta1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["zeta2 gift","zeta2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["zeta3 gift","zeta3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "line.me/ti/p/~archaniczenit"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"zeta1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"zeta2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"zeta3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["bot","zeta"]:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
            ...
            elif "zeta1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("zeta1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "zeta2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("zeta2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "zeta3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("zeta3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "zeta4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("zeta4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    cl.sendImageWithURL(msg.to, zeta)
            ...
            elif "/zeta" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/zeta","zeta")
            ...
            elif "/zeta1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/zeta1","zeta1")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/zeta2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/zeta2","zeta2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/zeta3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/zeta3","zeta3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/zeta4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/zeta4","zeta4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
            ...
            elif msg.text in ["zeta1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["zeta2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["zeta3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["zeta4 acc invite"]:
                if msg.from_ in admin:
